        ...
        <div class="container w-full   mx-auto px-2">
            ...
            <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                <div class="flex flex-row justify-between pb-3 ">
                    <x-sub-title>Listagem dos Quiz</x-sub-title>
                    ...
                    <tbody>
                        @foreach ($quizzes as $quiz)
                            <tr x-data="{ open: false }" class="border border-black/40 ">
                                <td class="text-left py-3 pl-2">{{ $quiz->title }}</td>
                                <td class="text-left">{{-- {{ $quiz->module->title }} --}}</td>
                                <td class="text-center">{{ $quiz->questions->count() }}</td>
                                <td class="text-left hover:text-sky-800"><a
                                        href="{{ route('quizzes.show', $quiz->id) }}"> Ver
                                        perguntas</a></td>
