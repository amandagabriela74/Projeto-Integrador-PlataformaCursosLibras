...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Criação das alternativas <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                        <form action="<?php echo e(route('alternatives.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class=" mb-6 ">
                                <div>
                                    <label for="alternative"
                                        class="block mb-1 text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('Alternativa')); ?></label>
                                    <input type="text" name="alternative"
                                        placeholder="<?php echo e(__('Digite uma alternativa')); ?>"
                                ...
                                <div>
                                    <label class="block mb-1 text-lg font-medium text-gray-900 dark:text-white"
                                        for="alternative"><?php echo e(__('A alternativa está correta?')); ?></label>
                                    <select name="correct">
                                ...
                                <div>
                                    <label for="questionId"
                                        class="block mb-1 text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('De qual questão é essa pergunta?')); ?></label>
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/alternatives/create.blade.php ENDPATH**/ ?>