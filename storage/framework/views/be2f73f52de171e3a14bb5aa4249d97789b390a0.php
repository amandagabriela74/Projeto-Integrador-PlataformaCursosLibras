<div class="flex w-full h-screen">
    ...
    <div class="bg-sky-400 w-5/12 h-scren text-center flex flex-col justify-center items-center">
        ...
        <a class="text-sky-400 m-2 px-3 py-2 bg-white font-extrabold drop-shadow-xl rounded-xl" href="<?php echo e(route('register')); ?>">Cadastrar-se</a>
    </div>
</div>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/components/auth-card.blade.php ENDPATH**/ ?>