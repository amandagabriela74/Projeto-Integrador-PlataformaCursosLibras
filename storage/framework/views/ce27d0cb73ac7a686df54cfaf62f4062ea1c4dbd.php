...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Edição do Módulo - <?php echo e($course->module->title); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
                        ...
                        <form action="<?php echo e(route('courses.update', $course->id)); ?>" method="post">
                            ...
                            <div class=" mb-6 ">
                                <div>
                                    ...
                                    <input type="text" name="titulo" value="<?php echo e(old('titulo', $course->titulo)); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="topico" value="<?php echo e(old('topico', $course->topico)); ?>"
                                        class="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                <div>
                                    <label for="embed"
                                        class="block mb-1 text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('Embed')); ?></label>
                                    <input type="text" name="embed" value="<?php echo e(old('embed', $course->embed)); ?>"
                                        class="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                <div>
                                    <label for="descricao"
                                    ...
                                    <input type="text" name="descricao"
                                        value="<?php echo e(old('descricao', $course->descricao)); ?>"
                                        class="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/courses/edit.blade.php ENDPATH**/ ?>