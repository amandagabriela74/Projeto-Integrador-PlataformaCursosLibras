                ...
                <table  class="w-full divide-y divide-gray-200"">
                    ...
                    <tbody>
                        ...
                        <tr x-data="{ open: false } class="">
                            ...
                            <td class="text-center"><?php echo e($question->quiz->title); ?></td>
                            <td class=" flex flex-row">
                                <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-4 rounded"
                                    href="<?php echo e(route('questions.edit', [$question->id])); ?>">Editar</a>
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/questions/index.blade.php ENDPATH**/ ?>