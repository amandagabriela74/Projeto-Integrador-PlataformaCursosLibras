...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Criação dos Módulos <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
                        ...
                        <form action="<?php echo e(route('modules.store')); ?>" method="post">
                            ...
                            <div class=" mb-6 ">
                                <div>
                                    ...
                                    <input type="text" name="title" placeholder="<?php echo e(__('Digite um título')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/modules/create.blade.php ENDPATH**/ ?>