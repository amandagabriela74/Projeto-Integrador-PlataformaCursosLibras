...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Cursos do módulo : <?php echo e($module->title); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
                ...
                <table class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;"">
                    <thead>
                        <tr class="">
                            ...
                            <th class="text-center text-2xl ">Tópico</th>
                            <th class="text-center text-2xl ">Embed</th>
                            <th class="text-center text-2xl ">Descrição</th>

                        </tr>
                    </thead>
                    <tbody>
                        <?php $__currentLoopData = $moduleCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h4 class="text-2xl font-bold text-gray-700 dark:text-white">
                                <tr class="border border-black/40">
                                    <th class="text-center">
                                        <?php echo e($course->titulo); ?> </th>
                                    <th class="text-center">
                                        <?php echo e($course->topico); ?> </th>
                                    <th class="text-center">
                                        <?php echo e($course->embed); ?> </th>
                                    <th class="text-center">
                                        <?php echo e($course->descricao); ?> </th>
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/modules/show.blade.php ENDPATH**/ ?>