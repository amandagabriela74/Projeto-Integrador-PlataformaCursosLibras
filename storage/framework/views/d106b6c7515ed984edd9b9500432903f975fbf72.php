...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Listagem dos Módulos <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                    <a href="<?php echo e(route('modules.create')); ?>"
                        ...
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border border-black/40">
                                <th class="text-center">
                                    <?php echo e($module->title); ?> </th>

                                <td class="text-center hover:text-sky-800"><a
                                        href="<?php echo e(route('modules.show', $module->id)); ?>"> Ver
                                        cursos</a></th>
                                <td class="text-center"><?php echo e($module->courses->count()); ?></td>

                                <th class="flex flex-row justify-center gap-2"">
                                    <a href="<?php echo e(route('modules.edit', [$module->id])); ?>">
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/modules/index.blade.php ENDPATH**/ ?>