...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Listagem dos Quiz <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                ...
                <table class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    <thead>
                        <tr>
                            <th class="text-left  text-2xl">Título</th>
                            <th class="text-left  text-2xl">Módulo</th>
                            <th class=" text-2xl">Número de Perguntas</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr x-data="{ open: false }" class="border border-black/40 ">
                                <td class="text-left py-3 pl-2"><?php echo e($quiz->title); ?></td>
                                <td class="text-left"></td>
                                <td class="text-center"><?php echo e($quiz->questions->count()); ?></td>
                                <td class="text-left hover:text-sky-800"><a
                                        href="<?php echo e(route('quizzes.show', $quiz->id)); ?>"> Ver
                                        perguntas</a></td>
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/quizzes/index.blade.php ENDPATH**/ ?>