...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Perguntas - módulo: <?php echo e($quiz->title); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
                ...
                <table class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;"">
                    <thead>
                        <tr class="">
                            ...
                            <th class="text-center text-2xl">Quantidade de alternativas</th>
                            <th class="text-center text-2xl "></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <h4 class="text-2xl font-bold text-gray-700 dark:text-white">
                                <tr class="border border-black/40">
                                    <th class="text-center">
                                        <?php echo e($question->question); ?> </th>
                                    <td class="text-center"><?php echo e($question->alternatives->count()); ?></td>
                                    <td class="text-left hover:text-sky-800"><a
                                            href="<?php echo e(route('questions.show', $question->id)); ?>"> Ver
                                            alternativas</a></td>
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/quizzes/show.blade.php ENDPATH**/ ?>