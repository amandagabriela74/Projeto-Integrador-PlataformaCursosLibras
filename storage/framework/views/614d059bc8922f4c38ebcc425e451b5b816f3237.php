                ...
                <div class="bg-white  w-4/6 overflow-hidden shadow-sm sm:rounded-lg my-20 py-8 px-24 ">
                    <div class="p-6 sm:p-0 border-gray-200">
                        <h4 class="text-2xl font-bold text-gray-700 pb-8 dark:text-white">
                            Edição do Módulo - <?php echo e($modules->title); ?></h4>
                        <form action="<?php echo e(route('modules.update', $modules->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class=" mb-6 ">
                                <div>
                                    ...
                                    <input type="text" name="title" value="<?php echo e(old('title', $modules->title)); ?>"
                                        placeholder="<?php echo e(__('Digite um título')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/amanda/Downloads/Projeto-Integrador-PlataformaCursosLibras/resources/views/quiz/modules/edit.blade.php ENDPATH**/ ?>